#დაწერეთ კოდი შემდეგი პირობისთვის:
#
#მოცემულია ხუთი ცვლადი (*ცვლადებს სახელები თქვენით შეურჩიეთ)
...
kenti3 = "C C C fanta C"
luwi4 = input("Python tu C++? ")
kenti5 = " Gavsebs cxovrebis xalisit, simshvidec chndeba tavisit YOO"
print(kenti1, luwi4)